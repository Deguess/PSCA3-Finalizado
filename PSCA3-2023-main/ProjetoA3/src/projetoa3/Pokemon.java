...
public class Pokemon extends javax.swing.JFrame {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        PokeCad cadastro = new PokeCad(this,-1);
    ...
    private void btnModActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModActionPerformed
        ...
        PokeCad cadastro = new PokeCad(this, Integer.parseInt(codigo));
        cadastro.setVisible(true);        
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        DB db = new DB("bancodados.db");
        String query = "DELETE FROM pokemon WHERE codigo="+codigo;
        db.execQuery(query);
        refresh();
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        DB db = new DB("bancodados.db");
        db.query("SELECT * FROM pokemon WHERE nome LIKE '%" + nomeBuscar + "%'");
        String cols[] = { "Código", "Nome", "Cor", "Geração", "Tipo" };
        String fields[] = { "codigo", "nome", "cor", "geracao", "tipo" };        
        TableRender.render(table, cols, fields, db);
        db.closeConnection(); 
